...
use App\UserRoles;
use App\Http\Resources\UserRoles as UserRolesResource;
...
class UserRolesController extends Controller
{
    ...
    {
        $res = UserRoles::with(['role', 'user']);

        return new UserRolesResource($res);
    }
    ...
    public function store(Request $request)
    {
        ...
        UserRoles::findOrFail($request->input('id')) : new UserRoles;
