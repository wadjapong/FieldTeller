...
class CreateFieldTellerFloatTransfers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('field_teller_float_transfers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('field_teller_float_transfers');
    }
}
