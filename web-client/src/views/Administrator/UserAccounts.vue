          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <h4>Add New {{ userGroupName }} User Account</h4>
              ...
              <div class="body table-responsive">
                <table class="table">
                  ...
                  <!-- <tbody v-if="orderDetails.length > 0">
                          <tr v-for="(order, i) in orderDetails" :key="i">
                            <td>
                              <img
                                :src="
                                  $store.state.storagePath +
