                          ...
                          <div class="form-group">
                            ...
                            <div class="demo-radio-button">
                              <input
                                ...
                                checked=""
                              />
                              <label for="sma1">Bank</label>
                              <input
                                name="settlement_account"
                                type="radio"
                                id="sma2"
                              />
                              <label for="sma2">MoMo</label>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card-body py-3 px-3">
                      <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Merchant Collection Account #</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Merchant Collection Account Balance</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th>Type</th>
                      <th>Parent</th>
                      <th>Collection Account Balance</th>
                      <th>Cash Pick Up Charge %</th>
                      <th>Field Teller Commission %</th>
