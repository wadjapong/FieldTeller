          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <h4>Register Field Teller</h4>
                    <div class="card-body py-3 px-3">
                      <div class="row clearfix">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Name</b>
                            <div class="form-line">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Parent</b>
                            <div class="form-line">
                              <select class="form-control show-tick">
                                <option value="">-- Select Parent --</option>
                                <option value="parent">Parent1</option>
                              </select>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="demo-radio-button">
                              <input
                                ...
                                checked=""
                              />
                              <label for="sma1">MoMo Wallet</label>
                              <input
                                name="settlement_account"
                                type="radio"
                                id="sma2"
                              />
                              <label for="sma2">Float Account</label>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Status</b>
                            <div class="form-line">
                              <select class="form-control show-tick">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card-body py-3 px-3">
                      <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller MoMo Wallet #</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Float Account #</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Commission Account #</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Float Account Balance</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Commission Account Balance</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Cash Pick Up Charge %</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Field Teller Commission %</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <b>Firm's Commission %</b>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th>Type</th>
                      <th>Parent</th>
                      <th>Float Account Balance</th>
                      <th>Commission Account Balance</th>
                      <th>Float Source</th>
                      <th>Status</th>
                      <th>Actions</th>
                    </tr>
                      ...
                      <td>
                        <div class="row action-buttons">
                          ...
                          <button
                            ...
                            title="Edit Field Teller"
                          >
                            <i class="material-icons">edit</i>
                          </button>
                          <button
                            type="button"
                            class="btn bg-black btn-circle waves-effect waves-circle waves-float"
                            title="Deactivate Field Teller"
                          >
